...
if(isset($_POST['ContactoEnviar']) && !empty($_POST['name']) && !empty($_POST['email']) && (!filter_var($_POST['email'], FILTER_VALIDATE_EMAIL) === false) && !empty($_POST['message'])){
    ...
    $to     = 'ecabrerablazquez@gmail.com';
    $subject= 'Solicitud de contacto enviada';
    
    $htmlContent= '
    <h4>La solicitud de contacto se ha enviado a BaulPHP, los detalles se detallan a continuación.</h4>
    ...
    $headers .= 'De: BaulPHP<ecabrerablazquez@gmail.com>' . "\r\n";
